...
//list[ch08/highlight/table.php][table.php][php]{
#@mapfile(ch08/highlight/table.php)
#@end
//}

HTML中で@<code>{content}カラムを表示していた所を、@<code>{snippets}に置き換えます。

//list[ch08/highlight/index.php][index.php][php]{
#@mapfile(ch08/highlight/index.php)
#@end
//}
...
//list[ch08/sort/table.php][table.php][php]{
#@mapfile(ch08/sort/table.php)
#@end
//}
